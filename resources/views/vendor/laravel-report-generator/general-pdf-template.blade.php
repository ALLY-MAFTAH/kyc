...
<body>
    ...
    <div class="wrapper">
        <div class="pb-5">
            <div class="middle pb-10 title" style="white-space: pre-wrap;">{{ $headers['title'] }}</div>
            <div class="middle pb-10 subtitle" style="white-space: pre-wrap;">{{ $headers['subtitle'] }}</div>
            @if ($showMeta)
